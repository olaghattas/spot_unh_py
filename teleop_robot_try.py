...
class TeleopInterface:
    ...
    def xbox_to_command(self):
        ...
        if any(end_eff) or any(end_eff_2):
            ...
            ## seems like calling _arm_angular_velocity_cmd_helper was overwriting cartesion velocity of _arm_cylindrical_velocity_cmd_helper
            self._arm_angular_velocity_cmd_helper('EndEff Rotation',  v_r = v_r_, v_theta = v_theta_, v_z = v_z_ , v_rx=v_rx_, v_ry=v_ry_, v_rz=v_rz_)
    ...
    def _arm_angular_velocity_cmd_helper(self, desc='', v_r = 0.0, v_theta = 0.0, v_z = 0.0 , v_rx=0.0, v_ry=0.0, v_rz=0.0):
