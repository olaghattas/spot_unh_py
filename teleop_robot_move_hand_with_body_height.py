    ...
    def xbox_to_command(self):
        ...
        if body == "Up": ## forward
            if buttons_pressed == "RT":
                ...
                v_z_ =  self.body_height - prev_body_height
            else: 
        ...
        if body == "Down": ## backward
            if buttons_pressed == "RT":
                ...
                prev_body_height = self.body_height
                self._change_height(-1)
                v_z_ =  self.body_height - prev_body_height # -ve if it goes down
            else:
                v_x_ = v_r_ = -VELOCITY_BASE_SPEED
            print("Down")
    ...
    def teleop_spot(self):
        ...
        try:
            ...
            while rclpy.ok():
                ...
                ## TODO
                # 1. get action
                # 2. get state: robot_state = robot_state_client.get_robot_state() robot_state.kinematic_state
                # 3. get images
